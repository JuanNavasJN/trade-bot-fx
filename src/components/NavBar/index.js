  ...
  render() {
    ...
    return (
      <nav className="navbar" style={styles}>
        ...
        <div className="links">
          <div className="link" onClick={(_) => this.handleClick("about")}>
            About Us
          </div>
          <div
            className="link"
          ...
          <div className="link" onClick={(_) => this.handleClick("features")}>
            Features
          </div>
          <div className="link" onClick={(_) => this.handleClick("partners")}>
            Reports
          </div>
          <div className="link" onClick={(_) => this.handleClick("contact-us")}>
            Contact Us
          </div>
        </div>
        {/* <img
